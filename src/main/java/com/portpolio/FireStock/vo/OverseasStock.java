...
public class OverseasStock {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OverseasStock)) return false;
        OverseasStock that = (OverseasStock) o;
        return Objects.equals(stockName, that.stockName);
    }

    @Override
    public int hashCode() {
        return Objects.hash(stockName, averagePrice, currentPrice, quantity, todaysFluctuationRate, yield, valuationLoss, purchaseAmount, balanceAssessment);
    }
}
